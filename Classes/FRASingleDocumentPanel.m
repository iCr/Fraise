...
@implementation FRASingleDocumentPanel

// A dummy class to be able to recognize a frontmost single document window in -[FRAProjectsController currentFRADocument]
