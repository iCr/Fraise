...
- (NSString *)genererateTemporaryPath
{
	...
	do {
		sequenceNumber++;
		temporaryPath = [NSString stringWithFormat:@"%ld-%ld-%ld.%@", [[NSProcessInfo processInfo] processIdentifier], (NSInteger)[NSDate timeIntervalSinceReferenceDate], sequenceNumber, @"strawberry"];
